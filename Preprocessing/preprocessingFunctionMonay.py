...
def preprocessImagesMonai(niftiDirec, x, y, z, train_test_split=False):
    ...
    if(train_test_split):
        ...
        try:
            ...
            print(i['label'])
        nifp.create_label_file(os.path.join(NIFIT_slices_direc,'train'), images_4D_file,'trainLabels.txt')
        nifp.create_label_file(os.path.join(NIFIT_slices_direc,'test'), images_4D_file,'testLabels.txt')
    else:
        ...
        try:
            ...
            print(i['label'])
        nifp.create_label_file(NIFIT_slices_direc, images_4D_file,'Labels.txt')
